...
export const predictionMarketAbi = [
  ...
  { "inputs": [], "name": "InvalidStakeIncrement", "type": "error" },
  { "inputs": [], "name": "InvalidStatus", "type": "error" },
  { "inputs": [], "name": "InvalidVault", "type": "error" },
  { "inputs": [], "name": "MarketStillActive", "type": "error" },
  { "inputs": [], "name": "NoStakeToSettle", "type": "error" },
  ...
  { "inputs": [], "name": "ZeroStake", "type": "error" },
  ...
  { "inputs": [], "name": "increaseBet", "outputs": [], "stateMutability": "payable", "type": "function" },
  ...
  { "inputs": [{ "internalType": "externalEbool", "name": "inputSideYes", "type": "bytes32" }, { "internalType": "bytes", "name": "inputProof", "type": "bytes" }], "name": "placeBet", "outputs": [], "stateMutability": "payable", "type": "function" },
  ...
  { "inputs": [], "name": "resolver", "outputs": [{ "internalType": "address", "name": "", "type": "address" }], "stateMutability": "view", "type": "function" },
  { "inputs": [{ "internalType": "address payable", "name": "user", "type": "address" }, { "internalType": "bool", "name": "winner", "type": "bool" }], "name": "settleClaim", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
