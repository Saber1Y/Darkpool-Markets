...
export const predictionMarketAbi = [
  ...
  { "inputs": [{ "internalType": "externalEuint32", "name": "inputAdditionalAmount", "type": "bytes32" }, { "internalType": "bytes", "name": "inputProof", "type": "bytes" }], "name": "increaseBet", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
