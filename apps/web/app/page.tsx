    ...
    <main className="mx-auto w-full max-w-6xl px-5 py-8">
      <section className="mb-8 rounded-xl border border-slate-800/70 bg-slate-900/50 p-6">
        ...
        <p className="mt-2 max-w-xl text-sm text-slate-400">
          Privacy-preserving prediction markets powered by fully homomorphic
          encryption. Your bets are encrypted on-chain.
        </p>
      </section>
      ...
      {loadError ? (
        <div className="rounded-xl border border-amber-700/40 bg-amber-900/10 p-5">
          <p>
            There are currently no Open Markets available please check back
            later!
          </p>
